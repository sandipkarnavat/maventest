...
public class HelloWorldTest {
	...
	public void shouldSayHelloWorld() {
		driver.get("http://localhost:6080/myfirstwebapplication");
		WebElement we = driver.findElement(By.xpath("html/body/h1[1]"));
		if (we.getText().contains("Welcome to Simple WebApp Demo...Login with Sandeep/sandy")) {
			System.out.println("### Home Page Successful ###");
		} else {
			System.out.println("Home Page Unsuccessful");
		}
		assertEquals("Welcome to Simple WebApp Demo...Login with Sandeep/sandy", we.getText());
	}
}